                            ...
                            <div style="width: 625px;" class="sign-panels sign-panels-review">
                                ...
                                <div class="review">
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="container p-0">
                                            <fieldset id='demo1' class="rating">
                                                ...
                                                <label class="full" for="1star_a-5" title="Awesome - 5 stars" required></label>
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" name="review" id="" class="leave-review-input" required>
                                    </div>
