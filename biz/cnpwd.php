    ...
    <div class="container">
            <form action="cnpwd.inc.php" method="POST">
                <div class="form-label-group"> 
                    <Input class="form-control" type="password" id="pwd" autofocus name="pwd" placeholder="Enter  your new password">
                    <label for="pwd">Enter New Password...</label>
                </div>
                <div class="form-label-group">
                    <Input class="form-control" type="password" id="pwdrepeat" name="pwdRepeat" placeholder="Repeat Passsword">
